...
async function main() {
  ...
  const pools = [
    ...
    [Math.trunc(6.1765 * 10000), '0xa85be3676C951EBC82C89782aBA8da6089D69cb5', 5],
    ...
    [Math.trunc(0.5882 * 10000), '0x8163083fDa83728e19c8F170E8C66D3b5E64379D', 5], // LP27 BR
    [Math.trunc(0.5882 * 10000), '0x05524153Bb4a37E84180c923A0186419B80c0e6b', 5], // LP28 SEQ
